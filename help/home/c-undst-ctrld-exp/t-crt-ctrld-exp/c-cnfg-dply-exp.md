...
Om du vill konfigurera experimentet måste du fylla i det experimentella konfigurationsblad som tillhandahålls av Adobe (namngivet [!DNL TestExperiment.xls] som standard). Den här filen konfigureras [!DNL Sensor] att utföra experimentet och är Excel-versionen av textfilen som du angav i [Ändra parametern ExpFile](../../../home/c-undst-ctrld-exp/t-en-ctrld-exp/c-mod-expfile-prm.md#concept-25232b386a654870becc789d4f1fcc28).
...
1. Om du har administratörsåtkomst till dina webb- eller programservrar går du till [!DNL Sensor] installationsmapp på alla [!DNL Sensor] datorn i webbklustret för att få åtkomst till [!DNL TestExperiment.xls] -fil. Om du inte har administratörsåtkomst kontaktar du kontohanteraren i Adobe för att begära [!DNL TestExperiment.xls] -fil.

1. Öppna [!DNL TestExperiment.xls] (du kan ändra namn på filen om du vill) och fylla i följande fält:
...
Följande är ett exempel på en slutförd [!DNL TextExperiment.xls] kalkylblad:
...
1. När du är klar med variablerna i kalkylbladet för experimentets konfiguration sparar du ändringarna och sparar sedan filen i tabbavgränsat textformat ( [!DNL *.txt]) med det namn du angav i parametern ExpFile i [!DNL Sensor] konfigurationsfil. Se [Ändra parametern ExpFile](../../../home/c-undst-ctrld-exp/t-en-ctrld-exp/c-mod-expfile-prm.md#concept-25232b386a654870becc789d4f1fcc28).
...
Du måste distribuera experimentkonfigureringsfilen till varje dator i webbklustret som kör en [!DNL Sensor] och betjäna de sidor som ingår i experimentet. Det kan du göra med hjälp av en manuell procedur eller med ditt befintliga innehållshanteringssystem.

**Distribuera testinnehåll**

* På varje program eller webbserver som kör [!DNL Sensor] som betjänar sidor som ingår i experimentet använder du din befintliga publiceringsprocess för att distribuera testinnehållet till rätt plats.
...
* På varje program eller webbserver som kör [!DNL Sensor] som betjänar sidor som ingår i experimentet, placerar textfilen för experimentkonfigurationen i den katalog som du angav i parametern ExpFile i [!DNL Sensor] konfigurationsfil. Se [Ändra parametern ExpFile](../../../home/c-undst-ctrld-exp/t-en-ctrld-exp/c-mod-expfile-prm.md#concept-25232b386a654870becc789d4f1fcc28).
