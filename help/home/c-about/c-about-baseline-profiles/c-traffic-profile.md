...
<table id="table_D981FB9F8B734E3C845A9628548565F1"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2">Formel: <span class="filepath"> Avslutar/Sidvisning </span><p>Nivå: Sidvy </p></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Formel: <span class="filepath"> Sessioner[Referer&lt;&gt; 'Inget' och Referent&lt;&gt;'bokmärken']</span></p> <p>Nivå: Session </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col3">Den genomsnittliga tiden (MM:SS) som en besökare tillbringar i en session. <p><p>Obs! Du kan använda det här måttet med <a href="https://experienceleague.adobe.com/docs/data-workbench/using/client/t-open-ins.html#Segment_Export" format="http" scope="external"> Segmentexport</a> -funktion. </p></p></td> 
  </tr> 
  <tr> 
   <td colname="col1"> Sessioner per sidvy </td> 
   <td colname="col2"> <p>Formel: <span class="filepath"> Sessioner efter sidvy</span></p> <p> Nivå: Session </p> </td> 
