...
## IIS på Microsoft Windows Server 2000 eller senare {#section-d5d602c3e87b4ecf910e71772350e865}

Exempel på filen txlogd.conf som krävs för Sensor for Internet Information Service (IIS) 5.x eller 6.x som körs i Microsoft Windows Server 2000 eller senare.
...
## Lotus Sametime på Windows Server 2000 eller senare {#section-36265b8192484a268ebafc42e941fdf2}

Exempel på filen txlogd.conf som krävs för Sensor för Lotus Sametime som körs i Microsoft Windows Server 2000 eller senare.
...
## Apache Server 1.3.x i RedHat Linux, Sun Solaris, FreeBSD eller Mac OSX {#section-36d0b6d761424d358280226a16e643d2}

Exempel på filen txlogd.conf som krävs för Sensor för Apache Server 1.3.x som körs under RedHat Linux 7.x, Sun Solaris 2.6 eller senare, FreeBSD 4 eller senare eller Mac OS X PowerPC.
...
## Apache Server 2.0.x eller 2.2 i Linux, Sun Solaris eller FreeBSD {#section-b87565beba44472483348d442329c3fe}

Exempel på filen txlogd.conf som krävs för Sensor för följande Apache-servrar.
