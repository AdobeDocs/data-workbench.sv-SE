---
description: Instruktioner om hur du installerar och konfigurerar IBM HTTP-server på IBM AIX 5.1 eller senare som körs med Microsoft Windows Server 2000 eller senare.
title: IBM HTTP Server på AIX 5.1 eller senare
...
# IBM HTTP Server på AIX 5.1 eller senare{#ibm-http-server-on-aix-or-later}

{{eol}}

Instruktioner om hur du installerar och konfigurerar IBM HTTP-server på IBM AIX 5.1 eller senare som körs med Microsoft Windows Server 2000 eller senare.
...
På din IBM AIX-server skapar du en katalog där Sensor-programfilerna ska installeras. Tänk på att diskkön också finns i den här katalogen, så se till att enheten du väljer har tillräckligt med utrymme för en kö med den storlek du behöver.
...
<table id="table_F4A46DBDE0874133B616235C32B6D9F8"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> Fil </th> 
   <th colname="col2" class="entry"> Standardbehörigheter </th> 
   <th colname="col3" class="entry"> chmod, kommando </th> 
  </tr> 
 </thead>
 <tbody> 
  <tr> 
...
## Lägg till insamlaren i webbprogrammet {#section-c5b83ae4ebce430aa764f951e849b333}

För WebSphere-servrar fungerar insamlaren som ett filter i serverbehållaren.

Om du vill lägga till insamlaren i webbprogrammet öppnar du filen web.xml för webbservern vars händelser Sensor fångar.
...
## Ange platsen för filerna för samlaren och det delade objektet {#section-b9c298fa645f4670b2503647d967846f}

Redigera startskriptet för Websphere för att deklarera platsen för filerna J2EECollector.jar och libvisual_sciences.so.
...
## Hämta ytterligare data {#section-bb1c2bccba9b4bc0b52abdbb4f9d42d7}
...
Så här hämtar du ytterligare data från en sida:
