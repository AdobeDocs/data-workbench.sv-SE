---
description: Detaljerade anvisningar för installation och konfigurering av Sensor för WebLogic Server 6.x eller senare som körs i Microsoft Windows Server 2000 eller senare.
...
Detaljerade anvisningar för installation och konfigurering av Sensor för WebLogic Server 6.x eller senare som körs i Microsoft Windows Server 2000 eller senare.
...
1. Skapa en katalog där du kan installera Sensor-programfilerna på din WebLogic-server. Tänk på att diskkön finns i den här katalogen, så se till att enheten du väljer har tillräckligt med utrymme för en kö med den storlek du behöver.
