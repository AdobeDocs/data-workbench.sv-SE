---
description: Detaljerade anvisningar för installation och konfigurering av Sensor för WebLogic Server 6.x eller senare som körs med Microsoft Windows Server 2000 eller senare.
title: WebLogic Server på Windows Server 2000 eller senare
...
# WebLogic Server på Windows Server 2000 eller senare{#weblogic-server-on-windows-server-or-later}

{{eol}}

Detaljerade anvisningar för installation och konfigurering av Sensor för WebLogic Server 6.x eller senare som körs med Microsoft Windows Server 2000 eller senare.
...
1. Skapa en katalog på din WebLogic-server där du kan installera Sensor-programfilerna. Tänk på att diskkön finns i den här katalogen, så se till att enheten du väljer har tillräckligt med utrymme för en kö med den storlek du behöver.
...
Instruktioner för ändring av startskript.

I skriptet som används för att starta WebLogic (till exempel C:\bea\user_projects\mydomain\startServer.cmd) redigerar du raden&quot;set JAVA_OPTIONS=&quot; för att ange definitionen java.library.path till katalogen som innehåller filen visual_sciences.dll.
