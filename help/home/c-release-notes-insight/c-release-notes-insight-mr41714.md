---
description: Adobe Analytics kommer att uppdatera och förbättra sin datafeed som driver Data Workbench för att dra nytta av profiler och målgrupper i Adobe Experience Cloud. Alla användare av Data Workbench måste vara redo att gå över till det nya dataflödesformatet senast den 21 april 2014.
title: Uppdateringar för april 2014
...
# Uppdateringar för april 2014{#updates-for-april-mr}

Adobe Analytics kommer att uppdatera och förbättra sin datafeed som driver Data Workbench för att dra nytta av profiler och målgrupper i Adobe Experience Cloud. Alla användare av Data Workbench måste vara redo att gå över till det nya dataflödesformatet senast den 21 april 2014.

Profiler och målgrupper ger en komplett och fullt användbar bild av kunder som kan användas i Adobe Experience Cloud och tredjepartstjänster. För att börja lägga grunden för nya funktioner i Analytics kommer nya Experience Cloud ID Service att läggas till i dataflödet i den kommande MR-versionen från april tillsammans med andra förbättringar och förbättringar. Den nya tjänsten är tillgänglig för alla kunder som använder Adobe Experience Cloud.

Ytterligare förbättringar och felkorrigeringar som ingår i denna nya datafeed listas nedan i det här avsnittet, samt anvisningar för hur du förbereder konfigurationen av Data Workbench.

## Förbättringar och felkorrigeringar för den nya datautmatningen {#section-0013de07da93411d929a1dfd0417f61b}

* Tillägg av Experience Cloud ID-tjänsten.
* Fältet Target Action har lagts till som stöd för Target-rapportering och -analys i Analytics.
* Förbättrad anpassning till rapport och analys genom att införliva [!DNL bot_id] värdet på produktradtyperna.
* Reducering av storleken på eVars-produkter utan förlust av datavärdenas integritet.
* Löste ett problem där vissa hashade värden skulle visa sig vid försäljning av eVars.
* Interna förbättringar i processen för att fortsätta leverera bättre stabilitet och prestanda.

## Uppdaterar Data Workbench-konfigurationen {#section-381fcd185af6474bb656501c096c451d}

Ändringar av Data Workbench säkerställer oavbruten integrering av dataflödet efter övergången. Under nästa schemalagda uppdatering av ombearbetningen är det den aktuella avkodargruppen i konfigurationsfasen för loggbearbetning. Det team som ansvarar för att hantera Data Workbench-arkitekturen kan utföra ytterligare uppgifter för att exponera och dra nytta av den nya besökaridentifieraren i Experience Cloud.

**Uppgifter för att uppdatera Data Workbench**

1. Leta reda på den aktuella avkodargruppen. Vanligtvis finns det i datauppsättningen\Loggbearbetning\Avkodning [!DNL Instructions.cfg] i en profilhanterare.
1. Högerklicka på det aktuella avkodningsformatet i konfigurationsfilen och välj Kopiera.
1. Högerklicka och klistra in en ny post under det aktuella avkodningsformatet.
1. Expandera det nya avkodningsformatet och lägg till två nya fältpositioner i slutet av listan. Dessa positioner kan lämnas tomma om du inte är redo att använda de nya fälten i datauppsättningen, eller definiera dem enligt följande.

   * [!DNL x-mcvisid]
   * [!DNL x-tnt-action]

## Avkodningsinstruktioner {#section-ba63132ce9604851ad319b6181011820}
