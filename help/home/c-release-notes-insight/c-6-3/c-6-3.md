...
<table id="table_E28A6D31E7D941F7A0C2048F0F0F7838"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> På panelen Finders kan du nu högerklicka på <span class="uicontrol"> fliken Dimensioner </span> och välja <span class="uicontrol"> Dimension Type &gt; Time </span>. En lista med tidsdimensioner visas i sökresultaten. <p> <img placement="break" id="image_BA6A577501A74088B55A881554C89F10" src="assets/time_dim.png" /> </p> </td> 
  </tr> 
  <tr> 
...
* **Uppdatera Meta.cfg-filen** ( [!DNL E:\..\Profiles\<your custom profile>\Context\meta.cfg)]för att ange uppdaterad lösenordskryptering för FSU-servern) och för att lägga till poster för Namnvärdepar för att dra nytta av [frågesträngsgrupperingen](../../../home/c-get-started/c-admin-intrf/c-query-que/c-query-string-grouping.md).
...
Om du vill köra **Best Fit Attribution** i Data Workbench måste du få nya certifikat från Adobe ClientCare för din klient-, server- och rapportserver (.pem-filer) som stöder Adobe Analytics Premium. Var och en av de nya certifikaten kommer att ha den här parametern:

```
Product = Premium
```

Premium Package är tillgängligt för hämtning **[!UICONTROL Software and Docs]** under **[!UICONTROL Getting Started]** fliken på arbetsytan **Profiler och Sök efter** filer. Navigera till `Profiles - Current\DataWorkBench\<language>\Data WorkBench_6.30-en-us\Premium_6.30_en-us.zip`.  När **Premium** -profilen har lästs in på servern måste du lägga till en *Premium* -parameter i den anpassade [!DNL Profile.cfg] filen. På så sätt kan din anpassade profil inkludera menyer, visualiseringar och arbetsytor som en del av Adobe Analytics Premium.
...
* **Lägg till Dimensioner** visar bara de *utökade Dimensionerna*. Du kan komma runt problemet genom att använda **Finders** -verktyget för att dra dimensioner till tabeller.
